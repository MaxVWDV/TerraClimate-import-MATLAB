...
%
%Usage:
%[vals,time] = terraclimate_fetch(folder,filename,lat_bounds,lon_bounds,years,months,var,averaging);
%
%Example:
%[vals,time] = terraclimate_fetch(pwd,'test_precipitation',[50 51.5],[-75.5 -74.5],[2000 2015],[1 12],'ppt','timeseries');
%
